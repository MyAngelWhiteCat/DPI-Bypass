...
[Скачать](https://github.com/MyAngelWhiteCat/DPI-Bypass/releases/latest) версию с обходом блокировки youtube, osu.direct, catboy.best, api.nerinyan.moe - зеркала для загрузки Osu! карт и текстовых каналов dicord можно [по ссылке](https://github.com/MyAngelWhiteCat/DPI-Bypass/releases/latest)
